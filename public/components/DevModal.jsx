                        ...
                        <Modal.Footer className="modal-footer">
                            <div className="row control-group">
                                ...
                                <div className="form-group col-xs-4 col-sm-4 floating-label-form-group controls">
                                    <DatePicker hintText="Set a date" onChange={this.props.onDateChange} value={this.props.date} required></DatePicker>
                                    <TimePicker hintText="Set a time" onChange={this.props.onTimeChange} value={this.props.time} required></TimePicker>
                                </div>
                                <div className="form-group col-xs-4 col-sm-4 floating-label-form-group controls">
